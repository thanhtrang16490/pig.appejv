...
import { Farm } from "@/lib/types/database";
...
export function EditFarmModal({ farm }: EditFarmModalProps) {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || "Không thể cập nhật trại");
      }
